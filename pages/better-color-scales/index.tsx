...
function Waffle({ scaleType, darkMode }: { scaleType?: "sqrt" | "linear" | "log"; darkMode?: boolean }) {
  ...
  return (
    <div>
      <div className="flex gap-4 items-center mb-4">
        ...
        <label>
          <input type="checkbox" checked={reverse} onChange={(e) => setReverse(e.target.checked)} className="mr-2" />
...
function ChartContent() {
  ...
  return (
    <>
      <p className="text-base leading-7 mb-4 text-gray-700">Better color scales than ever before</p>
